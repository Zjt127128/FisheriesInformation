...
/**
 * 网箱育苗、养殖技术经济资源信息共享系统
对象 tb_wangxiangyumiao
 * 
 * @author ruoyi
 * @date 2023-02-21
 */
public class Wangxiangyumiao extends BaseEntity
{
    ...
    /** 水体规格（立方米） */
    @Excel(name = "水体规格", readConverterExp = "立=方米")
    ...
    /** 苗种或成员平均价格 */
    @Excel(name = "苗种或成员平均价格")
    private String seedlingPrice;

    /** 苗种或成员平均价格(元/尾、元/kg) */
    @Excel(name = "苗种或成员平均价格(元/尾、元/kg)")
