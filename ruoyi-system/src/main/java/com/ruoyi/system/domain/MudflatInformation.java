...
/**
 * 海底滩涂增养殖技术经济资源信息共享系统信息对象 mudflat_information
 * 
 * @author ruoyi
 * @date 2023-10-03
 */
public class MudflatInformation extends BaseEntity
{
    ...
    public void setMudflatArea(String mudflatArea) 
    {
        this.mudflatArea = mudflatArea;
    }

    public String getMudflatArea() 
    {
        return mudflatArea;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("mudflatArea", getMudflatArea())
