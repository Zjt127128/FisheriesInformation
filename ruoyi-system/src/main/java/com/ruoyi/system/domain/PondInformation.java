...
/**
 * 池塘育苗、养殖技术经济资源信息共享系统信息对象 pond_information
 * 
 * @author ruoyi
 * @date 2023-10-03
 */
public class PondInformation extends BaseEntity
{
    ...
    /** 养殖技术 */
    @Excel(name = "养殖技术")
    private String cultureTechnology;
    ...
    public void setCultureTechnology(String cultureTechnology) 
    {
        this.cultureTechnology = cultureTechnology;
    }

    public String getCultureTechnology() 
    {
        return cultureTechnology;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("cultureTechnology", getCultureTechnology())
